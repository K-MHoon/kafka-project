package com.kmhoon.kafka.consumer;
...
public class OrderSerdeConsumerV2 {
    ...
    public void pollConsumes(long durationMillis, CommitType consumerType) {
        try {
            while (true) {
                if (consumerType == CommitType.SYNC) {
    ...
    public static void main(java.lang.String[] args) {
        ...
        orderSerdeConsumerV2.pollConsumes(100, CommitType.ASYNC);

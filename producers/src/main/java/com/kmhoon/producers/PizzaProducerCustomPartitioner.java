...
public class PizzaProducerCustomPartitioner {
    ...
    public static void main(String[] args) {
        ...
        props.setProperty(ProducerConfig.PARTITIONER_CLASS_CONFIG, "com.kmhoon.producers.CustomPartitioner");
        props.setProperty("custom.specialKey", "P001");

        // KafkaProducer
        KafkaProducer<String, String> kafkaProducer = new KafkaProducer<>(props);

        sendPizzaMessage(kafkaProducer, "pizza-topic-partitioner", -1, 100,0, 0, true);
        kafkaProducer.close();
    }
}
